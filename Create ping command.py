...
def check_expiration():
    # 指定程序不可执行的日期（假设为2023年12月1日）
    expiration_date = datetime.datetime(2023, 3, 1)
...
def main():
    ...
    #     title="选择旧配置文件", filetypes=[("Text Files", "*.txt;*.log")])
    #
    ...
    for filename in files:
        ...
        # 使用 os.path.join 构建输出文件的完整路径
        output_file_path = os.path.join(ping_folder, f'ping_command {device_name} {nowTime}.txt')
